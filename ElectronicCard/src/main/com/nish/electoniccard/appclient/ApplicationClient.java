...
public class ApplicationClient {
	public static void main(String[] args) {
		...
		DepositRunnable depositThread1 = new DepositRunnable(card, BigDecimal.valueOf(1000.00), "Amount deposited");
		...
		thread1.start();
		WithdrawRunnable withdrawThread1 = new WithdrawRunnable(card, BigDecimal.valueOf(10.00), "Amount deposited");
